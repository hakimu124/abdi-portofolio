  ...
  return (
    <section className="py-24 px-6 max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row gap-12 items-center">
        ...
        {/* Right side: 3D Avatar Placeholder */}
        <div className="flex-1 relative group">
          ...
          <div
            id="avatar-3d-placeholder"
            className="relative w-full aspect-square rounded-full border border-white/10 bg-surface/50 backdrop-blur-3xl flex items-center justify-center overflow-hidden shadow-2xl"
          >
            <div className="text-mist-dim font-mono text-sm animate-pulse">
              [ 3D AVATAR ENGINE ]
            </div>
          </div>
        </div>
